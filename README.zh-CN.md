...
<p align="center">
  ...
  ·
  <a href="https://keptmac.com/zh/changelog/">更新日志</a>
  ·
...
<img src="screenshots/zh-hero.webp" alt="Kept 会议详情：左侧逐字转写，右侧 AI 纪要" width="100%"/>

<img src="screenshots/zh-summary.webp" alt="Kept 可视化纪要：要点、决策与待办一页呈现" width="100%"/>

## 功能

* 💻 原生 macOS 应用，Swift 编写，专为 Apple Silicon 打造。
* 🎙️ **自己会开始** — 你一进会就开录；最后一个人离开约十秒后自动结束并开始转写。
* 🔒 **跑在你的 Mac 上** — 中文 FireRedASR2，英文 Parakeet。字级时间戳来自音频本身，中英混说也能保住。
...
* [下载 Mac 版](https://keptmac.com)

## 反馈

本公开仓库用于 [Issues 与提问](https://github.com/xlsama/kept/issues)。源码在别处。

报 bug 时尽量写上：

* Kept 版本（设置 › 通用）与 macOS 版本
* 你做了什么、期望怎样、实际怎样
* 若与转写或纪要有关：语言、会议大概多长

请勿粘贴不宜公开的会议内容——此 tracker 对世界可读。敏感事项请发邮件：<im.xlsama@gmail.com>

---

Kept 写给那些会太多、却还想纪要真正好用的人。若它每周能省你几小时，一份许可证就是在支持继续做下去 ❤️
